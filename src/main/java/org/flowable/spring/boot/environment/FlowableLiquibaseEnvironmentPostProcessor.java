 ...
 * 
 * NOTE FROM Jorge Mora Giménez: 
 * This class is overwritting Filip's class due to a strange behaviour of the method SpringBootVersion.getVersion().
 * SpringBootVersion.getVersion() returns "null" when it's executed in a Project Riff environment.
 * I will remove this overwritten class once I investigate the issue (probably with the help of Filip).
 */
@Order(100)
public class FlowableLiquibaseEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    protected String getLiquibaseProperty() {
        ...
        // Here is the check for null that it's necessary to make this class work in a Project Riff environment.
